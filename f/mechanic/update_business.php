        ...
        <body>
            ...
            <div class="container">
                ...
                <form action="update_record.php" method="POST" onsubmit="return validateForm()">
                    ...
                    <input type="text" id="name" name="name" value='<?php echo $row['fullname']; ?>' required>

                    <label for="email">Email:</label>
                    <input type="email" id="email" name="email" value='<?php echo $row['email']; ?>' required>

                    <label for="phone">Phone Number:</label>
                    <input type="tel" id="phone" pattern="[0-9]{10}"  name="phone" value='<?php echo $row['phone_no']; ?>' required>

                    <label for="whatsapp_no">Whatsapp Number:</label>
                    <input type="tel" id="whatsapp_no" pattern="[0-9]{10}" name="whatsapp_no" value='<?php echo $row['whatsapp_no']; ?>' required>
